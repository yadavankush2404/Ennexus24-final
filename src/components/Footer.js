                        ...
                        <div className="col-md-4 col-sm-4 col-xs-4 cont mb-3">
                            <div className="footer-text ">
                                <div className="d-flex">
                                    <h1 className="font-weight-bold mr-2 px-3 fonT" style={{ color: "white", backgroundColor: "rgb(0, 225, 143)" , fontWeight:"600" }}> CES</h1>
                                    <h1 className="fonT" style={{ color: "rgb(0, 225, 143)",fontWeight:"600" }}>MMMUT</h1>
                                </div>
